...
<section class="couple-section color-primary moveable-section" data-id="1">
    <div class="image-wrapper">
        <div class="image-element">
            <img data-src="{{ asset('images/'.$event->image) }}" alt="{{ $event->title }}" title="{{ $event->title }}" class="lazyload" />
        </div>
    </div>
                    ...
                    <div class="col-md-6 col-lg-5 col-xl-4">
                        <div class="couple">
                            <div class="image-wrap man">
                                ...
                                <div class="image-element">
                                    <img data-src="{{ asset('images/'.$couple->image) }}" alt="{{ $couple->image_caption }}" title="{{ $couple->image_caption }}" class="couple-image man lazyload"
                                    />
                                </div>
                                <div class="ornaments-wrapper overflow-hidden">
                                    <div class="corner-1">
