            ...
            <div class="card mb-4">
                ...
                <form action="{{ route('configuration.wishes.save') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="description" name="description" class="form-control {{ ($errors->any() && $errors->has('description')) ? 'is-invalid' : '' }}" placeholder="Insert Description" cols="10" rows="5">{{ old('description', isset($wishes->description) ? $wishes->description : '') }}</textarea>
