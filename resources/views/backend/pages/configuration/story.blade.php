    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                <form action="{{ route('configuration.story.save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label">Title <i class="required">*</i></label>
                        <input type="text" name="title" class="form-control {{ ($errors->any() && $errors->has('title')) ? 'is-invalid' : '' }}" placeholder="Insert Title" value="{{ old('title', isset($story->title) ? $story->title : '') }}" />
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="description" name="description" class="form-control {{ ($errors->any() && $errors->has('description')) ? 'is-invalid' : '' }}" placeholder="Insert Description" cols="10" rows="5">{{ old('description', isset($story->description) ? $story->description : '') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="image_caption" class="form-control {{ ($errors->any() && $errors->has('image_caption')) ? 'is-invalid' : '' }}" placeholder="Insert Image Caption" value="{{ old('image_caption', isset($story->image_caption) ? $story->image_caption : '') }}" />
