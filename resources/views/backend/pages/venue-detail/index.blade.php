...
@section('content')
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Venue Detail</span>
    </h4>
    ...
    <div class="card">
        <div class="card-datatable table-responsive">
            <table class="table table-bordered" id="datatableVenueDetail">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Name</th>
...
<script>
    $(document).ready(function(){
        $("#datatableVenueDetail").DataTable({
            processing: true,
            serverSide: true,
            paging: true,
            pageLength: 10,
            ajax: "{{ route('datatable.venue-detail') }}",
            buttons: false,
            searching: true,
            scrollY: 500,
            scrollX: true,
