            ...
            <div class="card mb-4">
                ...
                <form action="{{ route('couple.update', $couple->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="instagram_url" class="form-control {{ ($errors->any() && $errors->has('instagram_url')) ? 'is-invalid' : '' }}" placeholder="Insert Instagram URL" value="{{ old('instagram_url', $couple->instagram_url) }}" />
